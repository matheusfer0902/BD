 ...
 */
function read(stream, receiver, options) {

    if (!utils.isReadableStream(stream)) {
        return Promise.reject(new TypeError('Readable stream is required.'));
    }

    if (typeof receiver !== 'function') {
        return Promise.reject(new TypeError('Invalid stream receiver.'));
    }
